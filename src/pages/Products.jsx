        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '30px 20px' }}>
            <div style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
                ...
                <input
                    ...
                    style={{
                        padding: '10px 18px', width: '280px', borderRadius: '25px',
            ...
            {message && (
                <div style={{
                    background: '#e6f4ea', color: '#2e7d32', padding: '12px 20px',
                ...
                {filtered.map(product => (
                    ...
                    >
                        ...
                        <div style={{ padding: '16px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                            ...
                            <p style={{ color: '#777', fontSize: '13px', marginBottom: '12px', flex: 1, lineHeight: '1.4' }}>
                                {product.description}
                            </p>
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 'auto' }}>
                <span style={{ color: '#cc0000', fontWeight: '800', fontSize: '20px' }}>
                  ${product.price}
                </span>
                                <button
